...
public class LicenseTab extends javax.swing.JPanel {
    ...
    private void setMatches() {
    	...
    	if (m != null) {
    		...
    		case 0:
        		/* File has no license */
    			setLicense("This file is missing a license");
    			break;
    		case 1:
        		/* File has one license */
    			setLicense("This file corresponds to", m.get(0).toString());
    			break;
    		default:
        		/* File has several licenses */
    			setLicense("This file corresponds to", "several licenses");
    			break;
    		}
			...
			for (LicenseMatch match : m) {
		    	...
		    	for (MatchPosition pos : match.getMatchPositions()) {
		    		try {
			        	...
			        	ErrorManager.error("Error hilighting", e);
		    		}
		    	}
		    }
    	...
    	} else setLicense("This file is not a source file"); 
    }
    ...
    private void initComponents() {
        ...
        detailPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("File Overview"));
        licensesTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Legend", "License", "Match%"
            }
        ) {
        ...
        detailPane.addTab("Matches", licensesPane);
        ...
        detailPane.addTab("Free Fields", tagsPane);
        ...
        infoLabel.setText("This file corresponds to");
        ...
        conflictsLabel.setText("This file has license conflicts (click to show)");
