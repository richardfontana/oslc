...
public class LicenseDatabase {
    ...
    public License getModuleLicense(String ModuleLicenseId) {
        ...
        {
            Log.log(LogEntry.DEBUG, "Abreviation not found.");                    
    ...
    public void buildLicenseDatabase() {
	    ...
	    ErrorManager.error("License directory file not found");
        }
        ...
        for (i = 0; i < licenseFiles.length; i++) {
            ...
            Log.log(LogEntry.DEBUG, "Found license meta file: "+licenseFiles[i]);
            ...
            Log.log(LogEntry.DEBUG, "Loading license text file:" + licenceTextFile);
		    ...
		    ErrorManager.error("Error while opening license text file:"+licenceTextFile,ex);
                }

                Log.log(LogEntry.DEBUG, "Loaded license:" + license);
            	...
            	ErrorManager.error("License text file:"+licenceTextFile+" doesn't exist");
            }
        }
	 ...
	 */
	    ...
	    if (license == null) {
		ErrorManager.error(str + "is null while its meta exists.");
		continue;
	    }
            ...
            try {
            	...
            	ErrorManager.error("Error while loading license file: "+licenseFiles[i],ex);
            }
        ...
        Log.log(LogEntry.VERBOSE, "License database loaded");
    }
}
